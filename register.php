...
<body>
    ...
    <main class="container my-4">
        <h1 class="mb-4">Kreiraj račun</h1>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <form action="process_register.php" method="POST">
                    ...
                    <div class="mt-3">
                        <p class="mb-0">Već imaš račun? <a href="login.php">Prijavi se ovdje</a></p>
                    </div>
                </form>
            </div>
            <div class="col-md-6 mb-4">
                ...
                <p class="text-muted mt-2">Pridruži se našoj zajednici da dobiješ pristup ekskluzivnom sadržaju</p>
            </div>
        </div>
    </main>
